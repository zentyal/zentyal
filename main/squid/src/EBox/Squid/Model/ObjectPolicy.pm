...
sub _table
{
    ...
    my @tableHeader = (
         ...
         new EBox::Types::HasMany(
                 ...
                 'view' => '/Squid/View/ObjectGroupPolicy',
                 'backView' => '/Squid/View/ObjectGroupPolicy',
                 'size' => '1',
         ),
         new EBox::Types::Select(
    ...
    my $dataTable = {
        ...
        modelDomain        => 'Squid',
        defaultController  => '/Squid/Controller/ObjectPolicy',
...
{
    return __x('There are no network objects in the system. {open}Create{close} at least one object if you want to set a object policy',
open => q{<a href='/Objects/View/ObjectTable'>}, close => q{</a>});
}
