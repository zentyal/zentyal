...
try {
    ...
    if ($backupReport) {
        ...
        print '<script>document.getElementById(\'log\').href="https://"+document.domain+"/EBox/Log"; </script>';
    } else {
        print '<li>' . __('Download a configuration report by clicking') . ' <a href="#" class="nvac" onclick=\'document.forms[0].action="https://"+document.domain+"/EBox/Backup"; document.forms[0].submit();\'>' . __('here') . '</a>.</li>';
    }
