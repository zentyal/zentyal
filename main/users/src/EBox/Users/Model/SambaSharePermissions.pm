...
# Class: EBox::Users::Model::SambaShareConfiguration
#
#  This model is used to configure permissions of each share
#  created in EBox::Users::Model::SambaShares
#
use strict;
use warnings;

package EBox::Users::Model::SambaSharePermissions;
...
sub viewCustomizer
{
        ...
        $custom->setHTMLTitle([
                {
                title => __('Shares'),
                link  => '/Users/Composite/General#SambaShares',
                },
                {
