...
# Returns:
#
#     <EBox::Users::Model::SambaShares> - the newly created object
#     instance
#
sub new
{
...
sub _table
{
    ...
    my $tableDesc = [
        ...
        new EBox::Types::HasMany(
            ...
            view => '/Users/View/SambaSharePermissions'),
    ...
    my $dataTable = {
        ...
        menuNamespace      => 'Users/View/SambaShares',
        class              => 'dataTable',
        help               => _sharesHelp(),
...
sub tagShareRightsReset
{
    ...
    if ($enabled) {
        ...
        my $sambaMod = EBox::Global->modInstance('users');
...
sub createDirs
{
    ...
    for my $id (@{$self->ids()}) {
        ...
        my @cmds = ();
        # Just create the share folder, the permissions will be set later on EBox::Users::_postServiceHook so we are
...
sub _syncAllShares
{
    my $samba = EBox::Global->modInstance('users');
