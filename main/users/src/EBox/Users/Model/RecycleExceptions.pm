...
# Class: EBox::Users::Model::RecycleExceptions
#
...
package EBox::Users::Model::RecycleExceptions;
...
# Returns:
#
#     <EBox::Users::Model::RecycleExceptions> - the newly created object
#     instance
#
sub new
{
...
sub shareModel
{
    return EBox::Global->modInstance('users')->model('SambaShares');
}
                       ...
                       subtypes =>
                        [
                            ...
                            new EBox::Types::Select(
                                ...
                                foreignField => 'share',
                                HTMLViewer => '/users/ajax/viewer/shareViewer.mas',
                                editable => 1)
                        ]
                      ),
      );
