...
# Class: EBox::Users::Model::Contacts
#
package EBox::Users::Model::Contacts;
...
sub row
{
    ...
    my $contact = new EBox::Users::Contact(dn => $id);
    if ($contact->exists()) {
        my %args = ();
        ...
        $args{edit} = "/Users/Contact?contact=$id";
...
sub removeRow
{
    ...
    new EBox::Users::Contact(dn => $id)->deleteObject();
...
sub addTypedRow
{
    ...
    my $contact = EBox::Users::Contact->create(\%args);
