...
sub masonParameters
{
    ...
    if (EBox::Global->communityEdition()) {
        my $RELEASE_ANNOUNCEMENT_URL = 'http://wiki.zentyal.org/wiki/Zentyal_5.1_Announcement';
        my $upgradeAction = "releaseUpgrade('Upgrading to Zentyal 5.1')";
        my $msg = { name => 'upgrade', text =>__sx('{oh}Zentyal 5.1{ch} is available! {ob}Upgrade now{cb}',
