...
sub _periodicMessages
{
    ...
    my $RELEASE_ANNOUNCEMENT_URL = 'http://trac.zentyal.org/wiki/Document/Announcement/3.2';
    my $upgradeAction = "releaseUpgrade('Upgrading to Zentyal 3.2')";
    unless (EBox::Global->modExists('software')) {
        ...
        $upgradeAction = "upgradeInstructions('Upgrading to Zentyal 3.2', '$instructionsHtml')";
    }
    ...
    return [
        {
         name => 'upgrade',
         text => __sx('{oh}Zentyal 3.2{ch} is available! {ob}Upgrade now{cb}',
