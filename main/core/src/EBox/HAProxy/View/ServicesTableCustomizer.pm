...
# Class: EBox::HAProxy::View::ServicesTableCustomizer
#
#   This class is used to override the EBox::View::Customizer method
#   that allows modification on the fields of the ServicesTable mode.
#   We make the port edition blocked per row based on its settings.
#
package EBox::HAProxy::View::ServicesTableCustomizer;
