...
DEB_CONFIGURE_SCRIPT_ENV += DHCPDCONF="/etc/dhcp/dhcpd.conf"
DEB_CONFIGURE_SCRIPT_ENV += DHCPDLEASES="/var/lib/dhcp/dhcpd.leases"
DEB_CONFIGURE_SCRIPT_ENV += DHCPDPID="/var/run/dhcp-server/dhcpd.pid"
DEB_CONFIGURE_SCRIPT_ENV += DHCPD_SERVICE="ebox.dhcpd4"
DEB_CONFIGURE_SCRIPT_ENV += DHCPD_INIT="/etc/init.d/isc-dhcp-server"
DEB_CONFIGURE_SCRIPT_ENV += DHCPD_INIT_SERVICE="isc-dhcp-server"
