    ...
    my @tableHead =
        (
         ...
         new EBox::OpenVPN::Types::TlsRemote(
                 ...
                 editable => 1,
                 help => __('If disabled all clients with a certificate ' .
                            'generated by eBox could connect.' .
                            ' When enabled only certificates whose common' . 
                            ' name begins with this value could connect.'
                           )
                 ),
