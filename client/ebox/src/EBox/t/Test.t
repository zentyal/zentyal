...
sub checkModuleInstantiationTest
{
  ...
  use Test::MockClass('EBox::Simple', 0.1, 'EBox::Unknown', 0.1, 'EBox::BadCreate', 0.1);

    package EBox::Unknown;
    ...
    package EBox::BadCreate;
    use base 'EBox::GConfModule';
    sub _create
    {
	my ($class, @params) = @_;
	my $self = $class->SUPER::_create(name => 'badCreate', @params);
    ...
    sub _create {     
      my ($class, @params) = @_;
      my $self =  $class->SUPER::_create(name => 'simple', @params);
      bless $self, $class;
      return $self;
    };
