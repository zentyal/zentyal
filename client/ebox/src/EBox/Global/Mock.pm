...
sub setEBoxModule
{
    ...
    EBox::GConfModule::Mock::setEntry("/ebox/modules/global/modules/$name/class", $module);
    EBox::GConfModule::Mock::setEntry("/ebox/modules/global/modules/$name/changed", undef);
    EBox::GConfModule::Mock::setEntry("/ebox/modules/global/modules/$name/depends", $depends) if defined $depends;
