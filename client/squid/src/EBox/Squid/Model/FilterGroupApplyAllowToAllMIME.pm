...
package EBox::Squid::Model::FilterGroupApplyAllowToAllMIME;
#
use strict;
use warnings;
...
sub listModel
{
  ...
  return $squid->model('FilterGroupMIMEFilter');
}
...
sub precondition
{
    ...
    my $useDefault = $parentComposite->componentByName('UseDefaultMIMEFilter', 1);
