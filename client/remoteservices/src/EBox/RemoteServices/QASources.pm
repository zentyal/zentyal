...
package EBox::RemoteServices::QASources;
...
sub pullSources
{
    ...
    my $sourceData = $self->soapCall('pullSources');
    if (not $sourceData) {
        throw EBox::Exceptions::DataNotFound('source data');
    }
...
sub serviceUrn
{
    return 'EBox/Services/QASources';
}
